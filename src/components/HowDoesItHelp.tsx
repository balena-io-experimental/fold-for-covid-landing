        ...
        <Flex flexDirection={["column", "column", "row"]}>
          <Box flex={1}>
            ...
            <Txt.p mt={3}>
              ...
              COVID-19, and attempt to predict the structure of proteins
              important to the disease as well as to produce new, stable
              mini-proteins to be used as potential therapeutics and
              diagnostics.
            </Txt.p>

            <Txt.p mt={3}>
              All the results from Rosetta@Home are public, such as the
              SARS-CoV-2 models that you can download.{" "}
              <ExternalLink
                label="here"
