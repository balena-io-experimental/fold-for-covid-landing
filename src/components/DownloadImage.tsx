...
const DOWNLOAD_IMAGE_ENDPOINT = `${API_ENDPOINT}/download`;
...
const deviceType = {
	...
	gettingStartedLink: {
		windows:
			'https://www.balena.io/docs/learn/getting-started/raspberrypi4/nodejs/',
		osx:
			'https://www.balena.io/docs/learn/getting-started/raspberrypi4/nodejs/',
		linux:
			'https://www.balena.io/docs/learn/getting-started/raspberrypi4/nodejs/',
	...
	logoUrl:
		'https://files.balena-staging.com/images/raspberrypi4-64/2.48.0%2Brev1.prod/logo.svg',
};
