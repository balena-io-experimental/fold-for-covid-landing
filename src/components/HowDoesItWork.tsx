			...
			<Flex flexDirection={['column', 'column', 'row']}>
				<Box flex={1}>
					<Txt.p>
						...
						involved. We at balena wanted to use our expertise in deploying and
						maintaining huge fleets of connected devices in some way to help
						with the current global health situation. We applied what we do
						best: making it as easy as possible for people to get projects up
						and running.
					</Txt.p>
					<Txt.p pt={3}>
						We noticed what the team over at Rosetta@home is doing and used our
					...
					<Txt.p pt={3}>
						<Txt.span italic>We’ve cut all of that out.</Txt.span> We built our
						own OS image, compatible with a whole range of computers; laptops,
						desktops and small devices like the Raspberry Pi. Next, we preloaded
						the OS image with the software required to contribute to the Rosetta
						project, and configured it with the settings necessary to get to
						work immediately.
					</Txt.p>
					<Txt.p pt={3}>
						You simply need to download the image and flash it to your device.
						Boot it up and it appears online and ready to start work. That’s it.
					</Txt.p>
					...
					<Txt.p>
						...
						<ExternalLink label="getting started guide" href="/#get-started" />{' '}
						getting started guide, we’ve set the system up to automatically
						configure the Wi-Fi connection with the network name and passphrase
						that you specify. <Txt.span bold>Note: </Txt.span>These credentials
						are injected into the image and then disposed of.
					</Txt.p>
					...
					<Txt.p>
						...
						/>{' '}
						), they are downloaded and fully applied automatically. The idea: to
						get your device running, and to keep it running, without any extra
						involvement.
					</Txt.p>
					<Txt.p pt={3}>
					...
					<Txt.p>
						...
						<ExternalLink label="balenaCloud" href="https://balena.io/cloud" />,
